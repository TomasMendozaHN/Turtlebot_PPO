...
struct SensorState_
{
  ...
  _right_encoder_type right_encoder;
   ...
   typedef int32_t _rear_left_encoder_type;
  _rear_left_encoder_type rear_left_encoder;

   typedef int32_t _rear_right_encoder_type;
  _rear_right_encoder_type rear_right_encoder;
...
// reducing the odds to have name collisions with Windows.h 
...
#endif
#if defined(_WIN32) && defined(ERROR_REAR_LEFT_MOTOR)
  #undef ERROR_REAR_LEFT_MOTOR
#endif
#if defined(_WIN32) && defined(ERROR_REAR_RIGHT_MOTOR)
  #undef ERROR_REAR_RIGHT_MOTOR
#endif
  ...
  enum {
    ...
    ERROR_REAR_LEFT_MOTOR = 3u,
    ERROR_REAR_RIGHT_MOTOR = 4u,
    TORQUE_ON = 1u,
    TORQUE_OFF = 2u,
  };
...
bool operator==(const ::turtlebot3_msgs::SensorState_<ContainerAllocator1> & lhs, const ::turtlebot3_msgs::SensorState_<ContainerAllocator2> & rhs)
{
  return lhs.header == rhs.header &&
    ...
    lhs.rear_left_encoder == rhs.rear_left_encoder &&
    lhs.rear_right_encoder == rhs.rear_right_encoder &&
...
struct MD5Sum< ::turtlebot3_msgs::SensorState_<ContainerAllocator> >
{
  ...
  {
    return "ff079ce73eeaeceed866ae3c3bea78bb";
  }

  static const char* value(const ::turtlebot3_msgs::SensorState_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xff079ce73eeaeceeULL;
  static const uint64_t static_value2 = 0xd866ae3c3bea78bbULL;
};
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::turtlebot3_msgs::SensorState_<ContainerAllocator> >
  {
    template<typename Stream, typename T> inline static void allInOne(Stream& stream, T m)
    {
      ...
      stream.next(m.rear_left_encoder);
      stream.next(m.rear_right_encoder);
...
struct Printer< ::turtlebot3_msgs::SensorState_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::turtlebot3_msgs::SensorState_<ContainerAllocator>& v)
  {
    ...
    s << indent << "rear_left_encoder: ";
    Printer<int32_t>::stream(s, indent + "  ", v.rear_left_encoder);
    s << indent << "rear_right_encoder: ";
    Printer<int32_t>::stream(s, indent + "  ", v.rear_right_encoder);
    s << indent << "battery: ";
